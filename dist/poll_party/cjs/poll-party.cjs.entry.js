...
const PollParty = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: "poll-party styled" }, index.h("header", null, index.h("h1", null, this.poll.question), index.h("div", { class: "total" }, totalVotes, " :\u0645\u062C\u0645\u0648\u0639 \u0627\u0644\u0631\u062F\u0648\u062F")), hasVoted ? (index.h("div", { class: "results" }, index.h("table", null, Object.entries(this.poll.options).map(([option, desc]) => {
      const votes = this.votes[option] || 0;
      return (index.h("tr", null, index.h("td", null, desc), index.h("td", null, index.h("strong", null, votes)), index.h("td", null, index.h("div", { class: "bar" }, index.h("div", { class: "bar-inner", style: {
          width: `${(votes / maxVotes) * 100}%`,
        } })))));
    })))) : (index.h("form", { onSubmit: (e) => this.submitVote(e) }, index.h("div", { class: "options" }, Object.entries(this.poll.options).map(([option, desc]) => (index.h("label", null, index.h("input", { type: "radio", name: "option", value: option, onChange: () => {
        this.selectedOption = option;
      } }), desc)))), index.h("button", { type: "submit", disabled: this.selectedOption === null }, "\u0642\u0645 \u0628\u0627\u0644\u062A\u0635\u0648\u064A\u062A"))))));
  }
  get hostEl() { return index.getElement(this); }
};
PollParty.style = pollPartyCss;

exports.poll_party = PollParty;

//# sourceMappingURL=poll-party.cjs.entry.js.map